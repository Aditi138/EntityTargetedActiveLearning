DIR="../data/Spanish/ETAL_FULL_CRF_CT"
DATA="../data/Spanish"
...
for i in {1..20} ; do
    ...
    MODEL_NAME="200_Entropy_Full_CT_spa_${i}.1_finetune"
    python -u ../main.py \
        --dynet-seed 3278657 \
        --word_emb_dim 100 \
        --batch_size 10 \
    ...
    NEW=`expr $i + 1`
    #!/usr/bin/env bash
    MODEL_NAME="200_Entropy_Full_CT_spa_${i}.1_finetune_activelearning"
    python -u ../main.py \
        --dynet-seed 3278657 \
        --mode test_1 \
        --fixedVocab \
  	...
  	--word_emb_dim 100 \
        ...
        --lang es \
        --misc \
        --load_from_path  ../saved_models/200_Entropy_Full_CT_spa_${i}.1_finetune.model \
        --pretrain_emb_path   $DATA/esp.vec  \
        --dev_path $DATA/esp.dev  \
